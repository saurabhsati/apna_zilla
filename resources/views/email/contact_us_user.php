            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                    ...
                    <td style="padding: 10px;"><a href="#"><img src="images/logo_header.png"  alt="logo" style="max-width: 221px;width: 100%;"></a></td>
                                    <td align="right" style="font-size:13px; font-weight:bold;padding-right: 10px;color:#000000;">{{ date('d M Y') }}</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td style="text-align:center; color:#aeaeae;background-color:#202020; padding-bottom:10px;"> Copyrights © {{ date("Y") }} by<span style="color:#fff;"> rightnext.com</span> All Rights Reserved. </td>
                        </tr>
                     </table>
                  </td>
               </tr>
