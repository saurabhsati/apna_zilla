          ...
          <form class="form-horizontal"
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label class="col-sm-3 col-lg-2 control-label">Gender </i></label>
             ...
             <div class="box-content">
               <div class="form-group">
                  ...
                  <div class="col-sm-5 col-lg-3 controls">
                     <input class="form-control date-picker" id="d_o_b"  data-date-format="dd-mm-yyyy" name="d_o_b" size="16" type="text" value="{{old('d_o_b')}}" data-rule-required="true"/>
                  </div>
