 ...
 <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group" style="" id="div_married_date" name="div_married_date">
                ...
                <div class="col-sm-6 col-lg-4 controls">
                    <input class="form-control date-picker" name="married_date" id="married_date" data-rule-required="" placeholder="Enter Married  Date" value="{{ date('d-m-Y',strtotime($arr_user_data['married_date'])) }}"/>
