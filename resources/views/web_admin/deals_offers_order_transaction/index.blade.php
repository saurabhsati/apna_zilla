          ...
          <div class="btn-toolbar pull-right clearfix">
            ...
            <div class="btn-group">
                <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip"
                     title="Refresh"
                     href="{{ url('/web_admin/deals_offers_transactions/') }}"
            ...
            <table class="table table-advance"  id="user_manage" >
              ...
              @foreach($arr_transaction as $key => $transaction)
                  ...
                  <tr>
                    ...
                    <td> {{ isset($transaction['order_deal']) && $transaction['order_deal']? ucfirst($transaction['order_deal']['title']):'' }}</td>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/web_admin/deals_offers_transactions/view/'.base64_encode($transaction['id'])) }}" class="show-tooltip" title="View">
                          <i class="fa fa-eye" ></i>
                        </a>
                         &nbsp;
                        <a href="{{ url('/web_admin/deals_offers_transactions/edit/'.base64_encode($transaction['id'])) }}" class="show-tooltip" title="Edit">
