                    ...
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img class="img-responsive img-thumbnail" src="" alt="Page logo" />
                                        <br/><br/>
                                    </div>
                                    <div class="col-md-9 user-profile-info">
                                        ...
                                        <p><span>Meta tag:</span> {{ isset($arr_pages['meta_tag'])?$arr_pages['meta_tag']:'' }}</p>
                                        <p><span>Meta Url:</span> {{ isset($arr_pages['meta_url'])?$arr_pages['meta_url']:'' }}</p> 
                                       ...
                                       <!--  <p><span>Language:</span> {{ isset($selected_language)?$selected_language:'' }}</p>   -->                                          
