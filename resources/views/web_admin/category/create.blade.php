    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <form class="form-horizontal" id="validation-form" method="POST" action="{{ url('/web_admin/categories/store') }}" enctype="multipart/form-data">
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 col-lg-4 controls">
                    <input class="form-control" name="category" id="category" placeholder="Category Name" data-rule-required="true" />
