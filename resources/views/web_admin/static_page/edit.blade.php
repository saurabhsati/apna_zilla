        ...
        <div class="box-content">
          ...
          @endif
                ...
                <form class="form-horizontal"
                          id="validation-form"
                          method="POST"
                          action="{{ url('/web_admin/static_pages/update/'.$enc_id) }}"
                ...
                <div class="col-sm-6 col-lg-4 controls">
                    <input class="form-control" name="page_title" id="page_title" data-rule-required="true" value="{{$data_page['page_title']}}"/> <span class='help-block'>{{ $errors->first('page_title') }}</span>
                </div>
                </div>
                <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label" for="meta_keyword">Meta Title<i class="red">*</i></label>
                <div class="col-sm-6 col-lg-4 controls">
                    <input class="form-control" name="meta_title" id="meta_title" data-rule-required="true" value="{{$data_page['meta_title']}}"/>
                ...
                <div class="col-sm-6 col-lg-4 controls">
                    <input class="form-control" name="meta_keyword" id="meta_keyword" data-rule-required="true"  value="{{$data_page['meta_keyword']}}" />
                ...
                <div class="col-sm-6 col-lg-4 controls">
                    <input class="form-control" name="meta_desc" id="meta_desc" data-rule-required="true"   value="{{$data_page['meta_desc']}}"/>
                ...
                <div class="col-sm-6 col-lg-4 controls">
                    <textarea name="page_desc"  data-rule-required="true" class="form-control" >{{ $data_page['page_desc'] }}</textarea>
