    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          @endif
          <form class="form-horizontal" id="frm_manage" method="POST" action="{{ url('/sales_user/reviews/multi_action') }}">
          ...
          <div class="btn-toolbar pull-right clearfix">
            ...
            <div class="btn-group">
              ...
              @if(sizeof($arr_reviews)>0)
                  <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip"
                     title="Refresh"
                     href="{{ url('/sales_user/reviews/'.$enc_id) }}"
                     style="text-decoration:none;">
              ...
              @foreach($arr_reviews as $key => $_review)
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/sales_user/reviews/view/'.base64_encode($_review['id'])) }}" class="show-tooltip" title="View">
                          <i class="fa fa-eye" ></i>
                        </a>
                        &nbsp;
                    @if($_review['is_active']=="0")
                        <a  href="{{ url('/sales_user/reviews/toggle_status/').'/'.base64_encode($_review['id']).'/activate' }}">
                         <i class="fa fa-lock" ></i>
                         </a>
                        @elseif($_review['is_active']=="1")

                        <a  href="{{ url('/sales_user/reviews/toggle_status/').'/'.base64_encode($_review['id']).'/block' }}">
                        <i class="fa fa-unlock" ></i>
                        </a>
                       @endif
                        &nbsp;
                        <a href="{{ url('/sales_user/reviews/delete/'.base64_encode($_review['id']))}}"
