    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                ...
                <a href="{{ url('/').'/sales_user/offers/'.base64_encode($offers['deal_info']['id']) }}">Offer</a>
                @endforeach
                 @endif
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        @if(isset($arr_offers) && sizeof($arr_offers)>0)
          @foreach($arr_offers as $key => $offers)
            <form class="form-horizontal" id="validation-form" method="POST" action="{{ url('/sales_user/offers/update/'.base64_encode($offers['id'])) }}" enctype="multipart/form-data">
