    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          @endif
          <form class="form-horizontal" id="frm_manage" method="POST" action="{{ url('/sales_user/offers/multi_action') }}">
          ...
          <div class="btn-toolbar pull-right clearfix">
            <!--- Add new record - - - -->
                <div class="btn-group">
                   <a href="{{ url('/sales_user/offers/create/'.base64_encode($arr_deal['id']))}}" class="btn btn-primary btn-add-new-records">Add Offers</a>
            ...
            <div class="btn-group">
             <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip"
                   title="Refresh"
                   href="{{ url('/sales_user/offers/'.base64_encode($arr_deal['id']))}}"
                   style="text-decoration:none;">
                  ...
                  <tr>
                    ...
                    <td>
                     @if($offers['is_active']=="0")
                        <a  href="{{ url('/sales_user/offers/toggle_status/').'/'.base64_encode($offers['id']).'/activate' }}">
                           <i class="fa fa-lock" ></i>
                        </a>

                        @elseif($offers['is_active']=="1")
                        <a   href="{{ url('/sales_user/offers/toggle_status/').'/'.base64_encode($offers['id']).'/block' }}">
                           <i class="fa fa-unlock" ></i>
                        </a>
                        @endif
                        |
                       <a href="{{ url('/sales_user/offers/edit/').'/'.base64_encode($offers['id']) }}" class="show-tooltip" title="Edit">
                          <i class="fa fa-edit" ></i>
                        </a>
                        |
                         <a href="{{ url('/sales_user/offers/show/').'/'.base64_encode($offers['id']) }}" class="show-tooltip" title="Show">
                          <i class="fa fa-eye" ></i>
                        </a>
                        |
                        <a href="{{ url('/sales_user/offers/delete/').'/'.base64_encode($offers['id']) }}"
