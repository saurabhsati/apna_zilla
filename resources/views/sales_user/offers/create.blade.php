        ...
        <ul class="breadcrumb">
            ...
            <li>
                <i class="fa fa-money"></i>
                  <a href="{{ url('/').'/sales_user/offers/'.base64_encode($arr_deal['id']) }}">Offer</a>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <form class="form-horizontal" id="validation-form" method="POST" action="{{ url('/sales_user/offers/store') }}" enctype="multipart/form-data">
