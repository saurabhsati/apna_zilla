        ...
        <ul class="breadcrumb">
            ...
            <li>
                ...
                @if(sizeof($arr_business)>0)
                    <a href="{{ url('/').'/sales_user/deals/'.base64_encode($arr_business['id']) }}">Deal</a>
                @endif
            </li>
            <span class="divider">
                <i class="fa fa-angle-right"></i>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <form class="form-horizontal" id="validation-form" method="POST" action="{{ url('/sales_user/deals/store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5 col-lg-3 controls">
                    <div class="input-group date ">
                        ...
                        <input name="end_day" id="end_day" class="form-control" type="text"  size="16" data-rule-required="true" readonly="" />
...
<script type="text/javascript">
         ...
         $(document).ready(function () {
            ...
            function newCategoryDishes(ref)///Load New Div with Category Select, Dish Select and Enter Quantity
              {
                var field= "";
                ...
                var field = field + '<div class="form-group dish_deal" id="new_div">'+
                                   '<label class="col-sm-3 col-lg-2 control-label deal_category_section" for="deal_category">Category<i class="red">*</i></label>' +
                                    ...
                                    '</div>'+
                                    '<i class="fa fa-minus-square-o fa-2x" style="cursor:pointer;" onclick="removeImage(this)"></i>'+
                                    '</div>';
              ...
              function removeImage(ref)////Remove Category, Dish and quantity Div
              {
                var parent_ref = jQuery(ref).parent('div.dish_deal');
...
<script type="text/javascript">
    ...
    function loadDishes()///Load dishes by ajax call
    {
        ...
        var url = "{{ url('/sales_user/deals/get_dishes/')}}/"+cat_id+"?_token="+token+"&loaded_dishes="+tmp_arr_selected_category_dishes+"&restaurant_id="+restaurant_id;
