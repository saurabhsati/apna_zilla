        ...
        <ul class="breadcrumb">
            ...
            <li>
                ...
                @if(isset($deal_arr['business_info']) && $deal_arr['business_info'] !='')
                    <a href="{{ url('/').'/sales_user/deals/'.base64_encode($deal_arr['business_info']['id']) }}">Deal</a>
                @endif
            </li>
            <span class="divider">
                <i class="fa fa-angle-right"></i>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        @if(isset($deal_arr) && sizeof($deal_arr)>0)
            <form class="form-horizontal" id="validation-form" method="POST" action="{{ url('/sales_user/deals/update/'.base64_encode($deal_arr['id'])) }}" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function removeCategoryDish(ref)
    {
        ...
        var url    = "{{ url('/sales_user/deals/delete_dish/') }}/"+deal_dish_id+"?_token="+token;
    ...
    function loadDishes()
    {
        ...
        var token = $('input[name="_token"]').val();
        var url = "{{ url('/sales_user/deals/get_dishes/')}}/"+cat_id+"?_token="+token+"&loaded_dishes="+arr_selected_category_dishes+"&restaurant_id="+restaurant_id;
