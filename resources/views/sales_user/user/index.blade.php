    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          @endif
          <form class="form-horizontal" id="frm_manage" method="POST" action="{{ url('/sales_user/users/multi_action') }}">
              ...
              <tbody>
               ...
               @if(isset($obj_user) && sizeof($obj_user)>0)
                  ...
                  <tr>
                    ...
                    <td>
                         @if($user->is_active=="0")
                        <a class="btn btn-danger" href="{{ url('/sales_user/users/toggle_status/').'/'.base64_encode($user->id).'/activate' }}">
                            Block
                        </a>

                        @elseif($user->is_active=="1")
                        <a  class="btn btn-success" href="{{ url('/sales_user/users/toggle_status/').'/'.base64_encode($user->id).'/block' }}">
                            Active
                        </a>
                        @endif
                    </td>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/sales_user/users/edit/').'/'.base64_encode($user->id) }}" class="show-tooltip" title="Edit">
                          <i class="fa fa-edit" ></i>
                        </a>

                        &nbsp;
                        <a href="{{ url('/sales_user/users/toggle_status/').'/'.base64_encode($user->id).'/delete' }}"
