                ...
                <div class="box-content">
                  ...
                  @endif
                    ...
                    <form class="form-horizontal"
                        ...
                        id="validation-form"
                        method="POST"
                        action="{{ url('/sales_user/update_profile')}}"
                          ...
                          <div class="col-sm-9 col-md-10 controls">
                             <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                   ...
                                   <img src="{{ url('/').config('app.project.img_path.user_profile_pic').'/'. $sales_user_arr['profile_pic'] }}" alt="" height="190px" width="190px" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-5 controls">
                                <input type="text"
                                value="{{ $sales_user_arr['office_landline'] }}"
                                class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-5 controls">
                                ...
                                name="street_address"
                                id="street_address"
                                data-rule-required="true" />{{ $sales_user_arr['street_address'] }}</textarea>
