         ...
         <div class="container">
            <div class="row">
              ...
              <div class="logo-block">
                  <a href="{{ url('/') }}" class="logo hidden-xs"><img src="{{ url('/') }}/assets/front/images/logo_header1.png" alt="logo" /></a>
               ...
               <div class="menublock">
                  ...
                  <div class="main-menu">
                     <div class="nav">
                         ...
                         <?php
                          ...
                          <!--  <li class="nav-item"><a href="{{ url('/') }}" class=" {{ Request::segment(1)==''? 'act':'' }}">Home</a></li> -->
                           ...
                           <li class="nav-item"><a href="{{ url('/') }}/{{$city}}/deals">Deals</a></li>
                            ...
                            @if(Session::has('mobile_no') || Session::has('user_id'))
                      ...
                      <?php
                       if(empty(session::get('mobile_no')) || empty(Session::has('user_id')))
                        {
