 ...
 <div class="col-sm-12 col-md-3 col-lg-3">
               <div class="categories_sect sidebar-nav slide_m">
                ...
                <ul class="add_business">
                  ...
                  <li class="brdr"><a class="{{ Request::segment(2)=='edit_business_step5'? 'active':'' }} " href="{{ url('/front_users/edit_business_step5/'.Request::segment(3))}}">Video/Pictures/Services</a></li>
