...
Route::group(['prefix' => '/web_admin', 'middleware' => ['web']], function () {
    ...
    Route::group(['prefix' => '/front_slider'], function () {
    ...
    Route::group(['prefix' => '/deals_offers'], function () {
    ...
    Route::group(['prefix' => 'contact_enquiry'], function () {
...
Route::group(['prefix' => '/', 'middleware' => ['web']], function () {
    ...
    Route::group(['prefix' => '/payumoney'], function () {
    ...
    Route::group(['prefix' => 'api', 'middleware' => 'api'], function () {
        ...
        Route::group(['prefix' => '/location_common'], function () {
        ...
        Route::group(['prefix' => '/category_common'], function () {
        ...
        Route::group(['prefix' => '/user_common'], function () {
        ...
        /* Transaction details*/
        Route::group(['prefix' => '/transactions_details'], function () {
