...
class OffersController extends Controller
{
    ...
    public function index($enc_id)
    {
        ...
        //dd($arr_offers);
       return view('sales_user.offers.index',compact('page_title','arr_offers','arr_deal'));
    ...
    public function create($enc_id)
    {
    	...
    	return view('sales_user.offers.create',compact('page_title','arr_deal'));
    ...
    public function show($enc_id)
    {
       ...
       // dd($arr_offers);
    	return view('sales_user.offers.show',compact('page_title','arr_offers'));
    }
    public function edit($enc_id)
    {
       ...
       // dd($arr_offers);
    	return view('sales_user.offers.edit',compact('page_title','arr_offers'));
    }
    ...
    {
        $id = base64_decode($enc_id);
        return OffersModel::where('id',$id)->update(array('is_active'=>1));
    }

    protected function _block($enc_id)////$enc_id = Offers id
    {
        $id = base64_decode($enc_id);
        return OffersModel::where('id',$id)->update(array('is_active'=>0));
    }
