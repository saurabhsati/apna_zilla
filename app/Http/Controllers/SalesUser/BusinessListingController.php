...
class BusinessListingController extends Controller
{
    ...
    public function index()
    {
       ...
       if($obj_main_category)
    	...
    	$business_listing = BusinessListingModel::where('sales_user_public_id',$sales_user_public_id)->with(['category','user_details','reviews'])->get()->toArray();
    	//dd($business_listing);
    ...
    public function create()
    {
        ...
        //dd($arr_category);
        return view('sales_user.business_listing.create',compact('page_title','arr_user','arr_category','arr_country','arr_zipcode','arr_city','arr_state'));
    }
    public function store(Request $request)
    {
        ...
        foreach ($business_cat as $key => $value)
        {
            ...
            /*$bussiness_category = new BusinessCategoryModel();
            $bussiness_category->category_id = $value;
    ...
    public function edit($enc_id)
 	{
        ...
        $business_data=BusinessListingModel::with(['category','user_details','city_details','zipcode_details','country_details','state_details','image_upload_details','service','business_times'])->where('id',$id)->get()->toArray();
 		//dd($business_data);
         return view('sales_user.business_listing.edit',compact('page_title','business_data','arr_user','arr_category','business_public_img_path','business_base_upload_img_path','arr_state','arr_country','arr_zipcode','arr_city','arr_upload_image'));
    ...
    public function show($enc_id)
    {
        ...
        $business_data=BusinessListingModel::with(['user_details','city_details','zipcode_details','country_details','state_details','category','service','image_upload_details'])->where('id',$id)->get()->toArray();
         //dd($business_data);
         return view('sales_user.business_listing.show',compact('page_title','business_data','business_public_img_path','business_base_upload_img_path','arr_main_category','arr_sub_category'));
