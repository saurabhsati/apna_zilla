...
class ReviewController extends Controller
{
    ...
    public function view($enc_id)
    {
        ...
        return view('sales_user.reviews.view', compact('page_title', 'arr_review_view'));
    }
    ...
    protected function _activate($enc_id)
    {
        ...
        return ReviewsModel::where('id', $id)->update(['is_active' => 1]);
    }
    ...
    protected function _block($enc_id)
    {
        ...
        return ReviewsModel::where('id', $id)->update(['is_active' => 0]);
    }
