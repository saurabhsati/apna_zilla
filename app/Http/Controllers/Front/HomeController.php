...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        } elseif (Session::has('search_city_title')) {
        ...
        $where_arr = ['is_popular' => 1, 'parent' => 0, 'is_active' => 1];
        ...
        foreach ($arr_business as $business) {
            ...
            if (count($business['category']) > 0) {
                ...
                $category_business['category_id'] = ['0'];
            }
        }
    ...
    public function get_city_auto(Request $request)
    {
        if ($request->has('term')) {
            ...
            if (count($arr_final_city_list) > 0) {
    ...
    public function get_location_auto(Request $request)
    {
        ...
        if ($request->has('term')) {
            ...
            if ($arr_obj_location) {
                ...
                $arr_final_location_list = [];

                if (count($arr_list_location) > 0) {
            ...
            if (count($arr_final_location_list) > 0) {
    ...
    public function get_deal_category_auto(Request $request)
    {
        if ($request->has('term')) {
            ...
            if (count($arr_final_deal_list) > 0) {
