...
class CategorySearchController extends Controller
{
    ...
    public function get_business(Request $request, $city, $cat_id, $ajax_set = 'false')
    {
        ...
        if ($cat_id == 0) {
            ...
            $arr_business = $arr_sub_cat = $parent_category = $sub_category = [];
        ...
        $mete_title = '';
        if (isset($parent_category[0]['title']) && count($parent_category[0]['title'])) {
            $mete_title = $parent_category[0]['title'];
        }

        $meta_desp = '';
        if (isset($parent_category[0]['cat_meta_description']) && count($parent_category[0]['cat_meta_description'])) {
            $meta_desp = $parent_category[0]['cat_meta_description'];
        }

        $meta_keyword = [];
        if (isset($parent_category[0]['cat_meta_keyword']) && count($parent_category[0]['cat_meta_keyword'])) {
        ...
        if ($ajax_set == 'false' && count($obj_business_listing) > 0) {
            ...
            if ($obj_business_listing) {
                ...
                //dd($arr_tmp);
                if (isset($arr_tmp['data']) && count($arr_tmp['data']) > 0) {
        ...
        } elseif (count($obj_business_listing) > 0) {
    ...
    public function search_business_by_location(Request $request, $city, $cat_loc, $cat_id, $page = '1')
    {
        ...
        if ($page == '1' && count($obj_business_listing) > 0 && isset($obj_business_listing)) {
            ...
            // dd($chk_arr);
            if (isset($chk_arr) && count($chk_arr) > 0) {
