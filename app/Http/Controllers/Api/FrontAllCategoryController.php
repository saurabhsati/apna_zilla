...
class FrontAllCategoryController extends Controller
{
    ...
    public function get_popular_and_normal_Category(Request $request)
    {
        ...
        $popular_cat = [];
        if (isset($arr_popular_category) && count($arr_popular_category) > 0) {
        ...
        if (isset($arr_normal_category) && count($arr_normal_category) > 0) {
    ...
    {
        $data = $arr_final_list = $arr_sub_category = [];
        $serch_name = $request->input('serch_name');
        $city = $request->input('city');

        $deal_data = $business_data = [];
    ...
    public function get_business_details(Request $request)
    {
        ...
        $obj_business_details = BusinessListingModel::where(['id' => $business_id, 'is_active' => '1'])->with(['business_times', 'user_details', 'also_list_category.category_list', 'image_upload_details', 'payment_mode', 'category_details', 'service', 'reviews' => function ($query) {
        ...
        */
        ...
        if (isset($business_rating_count['reviews']) && count($business_rating_count['reviews']) > 0) {
        ...
        if (isset($arr_business_details) && count($arr_business_details) > 0) {
            $json['data'] = $data;
            $json['status'] = 'SUCCESS';
