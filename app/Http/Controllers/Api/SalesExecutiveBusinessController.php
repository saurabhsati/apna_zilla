...
class SalesExecutiveBusinessController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($business_listing) && count($business_listing) > 0) {
            foreach ($business_listing as $key => $business) {
                ...
                if (isset($business['user_details']) && count($business['user_details']) > 0) {
                ...
                $arr_data[$key]['reviews'] = count($business['reviews']);
                $arr_data[$key]['is_feature'] = count($business['membership_plan_details']);
                ...
                if (isset($business['category']) && count($business['category']) > 0) {
                    foreach ($business['category'] as $key2 => $selected_category) {
                        ...
                        if ($sub_category_title != '') {
                            ...
                            $arr_data[$key]['sub_category_title'] = [];
                        }
    ...
    public function review_index(Request $request)
    {
        ...
        $data = [];
        if (isset($arr_reviews) && count($arr_reviews) > 0) {
    ...
    public function show_review(Request $request)
    {
        ...
        $data = [];
        if (isset($arr_review_view) && count($arr_review_view) > 0) {
